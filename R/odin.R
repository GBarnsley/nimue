...
vaccine_ <- R6::R6Class(
  ...
  private = list(
    ...
    dll = "nimue",
    user = c("beta_set", "booster_doses", "D_0", "E1_0", "E2_0",
             "first_doses", "gamma_E", "gamma_get_mv_die",
